...
public class UserNodeConfigVO {
    ...
    private String nodeServerAddress; // Node.ip 或 Node.host

    @Schema(description = "节点端口 (服务端连接端口)", example = "49572")
    private Integer nodeServerPort; // Node.port
    ...
    private String wgAllowedIps;    // UserNodeConfig.wgAllowedIps
